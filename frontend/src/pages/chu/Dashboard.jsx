...
import { Calendar, XCircle, ArrowRightLeft, Clock, Activity, AlertTriangle, Building2, UserCircle2, CheckCircle2, File as FileIcon, Paperclip, ExternalLink } from 'lucide-react';
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            {queue.map((item) => (
              <div 
                ...
                className={`p-4 rounded-xl cursor-pointer border hover:border-chu-300 transition-all ${
                  selectedId === item.id 
                    ...
                    <div className="space-y-2">
                      {detail.ai_summary.split('\n').map((line, i) => (
                        <p key={i} className={`text-sm ${
                          i === 0 ? 'font-bold text-blue-900 text-base' : 
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {detail.attachments.map((att) => (
                        <a 
                          ...
                          className="group relative bg-gray-50 rounded-xl border border-gray-100 p-4 transition-all hover:bg-chu-50 hover:border-chu-200 flex flex-col items-center justify-center text-center gap-2"
                        >
